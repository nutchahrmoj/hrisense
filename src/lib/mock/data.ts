...
export const mockTrainingRecords = [
  ...
  { id: 'tr-7', personnel_id: 'p-7', personnel_name: 'นางสาวณัชชา อนันตวิเชียร', employee_number: 'EMP007', organization_id: 'org-4', organization_name: 'กองบริหารทรัพยากรบุคคล', course_name: 'การประยุกต์ใช้ AI และธรรมาภิบาลข้อมูลในงานยุติธรรม', course_type: 'เทคโนโลยี', provider: 'สถาบันพัฒนาข้าราชการ', start_date: '2026-06-15', end_date: '2026-06-18', training_hours: 32, cost: 15000, status: 'completed', certificate_number: 'CERT-2026-009', notes: 'ผ่านการประเมินความรู้ระดับดีเลิศ', created_at: '2026-06-19T09:00:00' },
]
